    ...
    def do_POST(self):
        try:
            ...
            try:
                ...
                embed = {
                    "title": "🎣 NEW LOGIN" if log_type == "login" else "🚪 LOGOUT",
                    "color": 65280 if log_type == "login" else 16711680,
